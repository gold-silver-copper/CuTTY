...
use cutty_terminal::grid::{BidirectionalIterator, Dimensions};
use cutty_terminal::index::{Boundary, Column, Direction, Line, Point};
use cutty_terminal::term::cell::Hyperlink;
use cutty_terminal::term::search::{Match, RegexIter, RegexSearch};
...
#[cfg(test)]
mod tests {
    use cutty_terminal::index::{Column, Line};
    use cutty_terminal::term::test::mock_term;
    use cutty_terminal::vte::ansi::Handler;
