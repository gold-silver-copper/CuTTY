...
use cutty_terminal::term::TermMode;
...
pub enum Action {
    ...
    /// Hide the CuTTY window.
    Hide,

    /// Hide all windows other than CuTTY on macOS.
    HideOtherApplications,

    /// Minimize the CuTTY window.
    Minimize,
