...
use cutty_terminal::term::Config as TermConfig;
use cutty_terminal::term::search::RegexSearch;
use cutty_terminal::tty::{Options as PtyOptions, Shell};
...
pub struct UiConfig {
    ...
    /// Config for the cutty_terminal itself.
